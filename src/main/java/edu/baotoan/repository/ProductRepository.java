...
import edu.baotoan.model.ReportInventory;
...
//	Page<Product> findAllByCategory(Pageable page);
	...
	@Query("select new edu.baotoan.model.ReportInventory(o.category, sum(o.unitPrice), sum(o.quantity)) from Product o group by o.category order by sum(o.quantity) desc")
