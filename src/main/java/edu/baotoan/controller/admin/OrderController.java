package edu.baotoan.controller.admin;
...
import edu.baotoan.domain.Order;
import edu.baotoan.domain.OrderDetail;
import edu.baotoan.domain.Product;
import edu.baotoan.repository.OrderDetailRepository;
import edu.baotoan.repository.OrderRepository;
import edu.baotoan.repository.ProductRepository;
import edu.baotoan.service.SendMailService;
...
public class OrderController {
	...
	public ModelAndView cancel(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn đã bị huỷ 1 đơn hàng từ HBT Shop!",
	...
	public ModelAndView confirm(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn có 1 đơn hàng ở HBT Shop đã được xác nhận!",
	...
	public ModelAndView delivered(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn có 1 đơn hàng ở HBT Shop đã thanh toán thành công!",
				"Chúng tôi cám ơn bạn vì đã ủng hộ HBT Shop!", "Thông báo thanh toán thành công!");
